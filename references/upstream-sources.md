...
- `docs/WeChat/Themebox主题盒子适配+config配置说明.md`
...
- checking current ThemeBox config behavior
...
- The upstream docs say updates may lag behind theme versions.
- `@@` indicates adapted but not fully organized.
