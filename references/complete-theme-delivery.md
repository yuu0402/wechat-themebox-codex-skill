...
- launch/wallpaper/backgrounds: follow the target slot or exported original dimensions; if unknown, use a portrait phone-safe aspect ratio as a provisional source asset and export to the measured target size before release.
